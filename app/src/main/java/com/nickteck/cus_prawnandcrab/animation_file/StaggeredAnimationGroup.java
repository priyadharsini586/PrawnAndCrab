...
import static com.nickteck.cus_prawnandcrab.animation_file.Utils.getConstraintLayoutParent;
import static com.nickteck.cus_prawnandcrab.animation_file.Utils.notNull;


public class StaggeredAnimationGroup extends Group {

    @VisibleForTesting
    static final int DEFAULT_PARTIAL_DURATION = 250;
    @VisibleForTesting
    static final int DEFAULT_PARTIAL_TRANSITION_DELAY = 50;
    @VisibleForTesting
    static final TimeInterpolator DEFAULT_PARTIAL_INTERPOLATOR = new FastOutSlowInInterpolator();
    @VisibleForTesting
    static PartialTransitionFactory defaultPartialTransitionFactory =
    ...
    @VisibleForTesting
    static OnTransitionPreparedListener defaultOnPreparedListener =
    ...
    @VisibleForTesting
    int partialDelay = DEFAULT_PARTIAL_TRANSITION_DELAY;
    @VisibleForTesting
    int partialDuration = DEFAULT_PARTIAL_DURATION;
    @VisibleForTesting
    TimeInterpolator partialInterpolator = DEFAULT_PARTIAL_INTERPOLATOR;
    @VisibleForTesting
    PartialTransitionFactory partialTransitionFactory = defaultPartialTransitionFactory;
    @VisibleForTesting
    OnTransitionPreparedListener onPreparedListener = defaultOnPreparedListener;
